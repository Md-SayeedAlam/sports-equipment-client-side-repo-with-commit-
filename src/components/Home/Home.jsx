  ...
  return (
    ...
    <div className="bg-base-300">
     ...
     <Theme></Theme>
      ...
      {/* Product Section */}
      <Fade direction="down"><h2 className="font-semibold text-2xl text-center">Sports Equipments</h2></Fade>
      <Fade direction="left">
      ...
      <section className="py-8 bg-base-300">
        <div className="container mx-auto px-4">
          <Fade direction="down"><h2 className="text-2xl font-bold text-center mb-6">
            Sports Categories
          </h2></Fade>
